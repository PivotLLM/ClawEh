...
type SkillsLoader struct {
	...
	globalSkills    string // global skills (~/.claw/skills)
...
func (sl *SkillsLoader) BuildSkillsSummary() string {
	return sl.BuildSkillsSummaryForSkills(sl.ListSkills())
}

func (sl *SkillsLoader) BuildSkillsSummaryForSkills(allSkills []SkillInfo) string {
	if len(allSkills) == 0 {
		return ""
	}
