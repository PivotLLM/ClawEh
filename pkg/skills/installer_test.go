...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "PivotLLM/ClawEh/skills/test",
			wantOwner:    "PivotLLM",
			wantRepoName: "ClawEh",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/PivotLLM/ClawEh/tree/dev/skills/test",
			wantOwner:    "PivotLLM",
			wantRepoName: "ClawEh",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/PivotLLM/ClawEh/blob/main/README.md",
			wantOwner:    "PivotLLM",
			wantRepoName: "ClawEh",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/PivotLLM/ClawEh",
			wantOwner:    "PivotLLM",
			wantRepoName: "ClawEh",
			wantRef:      "main",
			wantSubPath:  "",
