...
func TestCreateProvider_GeminiCli(t *testing.T) {
	...
	cfg.ModelList = []config.ModelConfig{
		{ModelName: "gemini-cli", Model: "gemini-cli/gemini-cli", Workspace: "/test/ws", Enabled: true},
	}
...
func TestCreateProvider_GeminiCliWithModel(t *testing.T) {
	cfg := config.DefaultConfig()
	cfg.ModelList = []config.ModelConfig{
		{ModelName: "gemini-flash", Model: "gemini-cli/gemini-2.5-flash", Workspace: "/ws", Enabled: true},
	}
...
func TestCreateProvider_GeminiCliDefaultWorkspace(t *testing.T) {
	...
	cfg.ModelList = []config.ModelConfig{
		{ModelName: "gemini-cli", Model: "gemini-cli/gemini-cli", Enabled: true},
	}
	cfg.Agents.Defaults.SetDefaultModel("gemini-cli")
