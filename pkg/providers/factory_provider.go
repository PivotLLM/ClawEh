...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	case "claude-cli", "claudecli":
		...
		if cfg.RequestTimeout > 0 {
			return NewClaudeCliProviderWithTimeout(workspace, time.Duration(cfg.RequestTimeout)*time.Second, cfg.ExtraArgs), modelID, nil
		}
		return NewClaudeCliProvider(workspace, cfg.ExtraArgs), modelID, nil
	...
	case "codex-cli", "codexcli":
		...
		if cfg.RequestTimeout > 0 {
			return NewCodexCliProviderWithTimeout(workspace, time.Duration(cfg.RequestTimeout)*time.Second, cfg.ExtraArgs), modelID, nil
		}
		return NewCodexCliProvider(workspace, cfg.ExtraArgs), modelID, nil
	...
	case "gemini-cli", "geminicli":
		...
		if cfg.RequestTimeout > 0 {
			return NewGeminiCliProviderWithTimeout(workspace, time.Duration(cfg.RequestTimeout)*time.Second, cfg.ExtraArgs), modelID, nil
		}
		return NewGeminiCliProvider(workspace, cfg.ExtraArgs), modelID, nil
