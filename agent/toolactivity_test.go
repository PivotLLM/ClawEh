...
func TestToolActivitySummary(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			want:    "🔧 `file_edit_lines` 10–12 `outline.md`",
			notWant: "SECRET",
		},
		{
