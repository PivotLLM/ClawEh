                ...
                cat > "$INTEG_HOME/config.json" <<EOF
{
  ...
  "tools": {
    ...
    "tool_overrides": {
      ...
      "cogmem_hook_search": true,
      "cogmem_domain_list": true,
      "cogmem_memory_explain": true,
      "cogmem_hook_create": true,
      "cogmem_domain_update": true,
      "cogmem_hook_retire": true,
      "cogmem_domain_create": true,
      "cogmem_domain_archive": true,
      "cogmem_hook_forget": true,
      "cogmem_memory_consolidate": true,
      "cogmem_memory_status": true
    }
  },
  "mcp_host": {
    "enabled": true,
    ...
    "tools": [
      ...
      "cogmem_hook_forget",
      "cogmem_memory_consolidate",
      "cogmem_memory_status",
      "common_list",
      "common_get",
      "common_put",
      "common_delete"
